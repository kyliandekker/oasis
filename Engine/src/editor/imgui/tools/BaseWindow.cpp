...
namespace oasis
{
	namespace imgui
	{
		BaseWindow::BaseWindow(ImGuiWindow& a_Window, ImGuiWindowFlags a_Flags, std::string a_Name, std::string a_WindowID, bool a_FullScreen) : m_Flags(a_Flags), m_Name(a_Name), m_WindowID(a_WindowID), m_FullScreen(a_FullScreen), ImGuiUIView(a_Window)
		{ }
